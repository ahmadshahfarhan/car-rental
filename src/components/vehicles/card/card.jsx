...
const Card = () => {
  ...
  return (
    <>
      <div>
        <h1 className=" md:text-[50px] text-[32px] font-bold font-worksans text-center mt-6">
          Select a vehicle group
        </h1>
        <div className=" mt-[40px] flex flex-wrap md:gap-5 gap-3 justify-center">
          <button
            onClick={() => handleClick("all")}
            className={cn(
              "transition-all rounded-[50px] md:px-[29.5px] px-4 md:py-[15.5px] py-3 md:text-[16px] text-[13px] font-worksans cursor-pointer",
              {
