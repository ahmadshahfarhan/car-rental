    ...
    <>
      <div className=" mt-[120px]">
        ...
        <div className=" flex justify-between">
          ...
          <button
            type="button"
            className=" font-worksans font-bold text-[20px] flex items-center gap-2 cursor-pointer"
          >
            views all
            <span>
              <MoveRight />
        ...
        <div className=" grid grid-cols-3 gap-8 mt-10">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className=" p-3 rounded-[12px]">
              <img src={TesImage} className="mx-auto rounded-[12px] w-full" alt="" />
              <div>
                <div className=" flex justify-between">
                ...
                <div className=" flex justify-start mt-[40px] gap-4">
                ...
                <button type="button" className=" font-inter text-surface bg-primary text-[16px] rounded-[12px] py-3 px-4 mt-4 w-full cursor-pointer">
                  View Details
                </button>
              </div>
            </div>
