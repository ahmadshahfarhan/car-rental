...
const FormHero = () => {
  ...
  return (
    <section>
      <div className="bg-primary rounded-[20px] w-full lg:w-sm h-[480px] flex items-center justify-center">
        <form className="p-[40px] flex flex-col justify-center items-center gap-4 w-full">
          <label className="font-worksans font-semibold md:text-[28px] text-[27px] leading-6 text-surface">
            Book your car
          </label>
